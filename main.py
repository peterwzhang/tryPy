    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            # handles mouse clicks (dragging blocks)
                ...
                dragging = True
                # deactivates text boxes when dragging
                ...
                # if there's a text box, check if clicked within text box
                if selectedBlock and selectedBlock.has_textbox():
            ...
            # handles keyboard typing
                ...
                # if in a text box, type keys in textbox
                if isActiveTextBox:
                    # if backspace is pushed, delete
                    if event.key == pygame.K_BACKSPACE:
                        selectedBlock.backspace()
                    # updates text to include key presses
                    else:
